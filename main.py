...
from routes.clinic_dashboard import router as clinic_dashboard_router
from routes.clinic_forgot_password import router as clinic_fp_router
...
app.include_router(clinic_dashboard_router)
app.include_router(clinic_fp_router)